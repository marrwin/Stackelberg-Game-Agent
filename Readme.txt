...
java -cp ejml-simple-0.40.jar:ejml-core-0.40.jar:ejml-ddense-0.40.jar: -Djava.rmi.server.hostname=127.0.0.1 SimpleLeader &


javac -d . -cp ejml-simple-0.40.jar:ejml-core-0.40.jar: src/SimpleLeader.java 
